...
\begin{enumerate}
	...
	\item Modificações na heurística de escalonamento do Shrink;
	\item Validação da nova heurística de escalonamento;
...
\scalebox{0.75}{
	\begin{tabular}{c|c|c|c|c|c|c|c|c} \hline
		Ano & \multicolumn{5}{|c|}{2020} & \multicolumn{3}{|c}{2021} \\ \hline
		Mês & Ago & Set & Out & Nov & Dez & Jan & Fev & Mar \\ \hline
		1   & \tn & \tn & \tn & &   &   &   &   \\ \hline
		2   &   & \tn & \tn & \tn & &   & &   \\ \hline
		3   &   &   &   & \tn & \tn & &   &   \\ \hline
		4   &   &   &   &   & \tn & \tn & \tn & \\ \hline
